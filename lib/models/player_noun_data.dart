...
class PlayerNounData {
  ...
  @override
  String toString() =>
      '{$id: {attempts: $attempts, timesCorrect: $timesCorrect, isFavorite: $isFavorite, isLearned: $isLearned, percentageCorrect: $percentageCorrect, isDifficult: $isDifficult, lastSeen: $lastSeen}}';
}
